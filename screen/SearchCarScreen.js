...
import { View, StyleSheet, KeyboardAvoidingView, Image, Platform, Text, TextInput, FlatList, TouchableOpacity } from 'react-native';
      ...
      <View style={styles.container}>
        <View style={styles.headingContainer}>
          <View style={{ flexDirection: "row", width: '100%', alignItems: "center", justifyContent: "space-between" }}>
            <Image source={require('./../assets/back-arrow.png')} style={{ height: 30, width: 30, resizeMode: "center" }} />
            <TextInput
...
const styles = StyleSheet.create({
  ...
  headingContainer: {
    ...
    width: '100%', position: "absolute", top: 25, zIndex: 1
  },
  heading: {
    fontSize: 24,
    fontWeight: 'bold',
